...
void USART_CFG(void){
		...
		GPIO_PinAFConfig(DEBUG_USART_TX_GPIO_PORT, DEBUG_USART_TX_SOURCE, GPIO_AF_USART1);
		GPIO_PinAFConfig(DEBUG_USART_RX_GPIO_PORT, DEBUG_USART_RX_SOURCE, GPIO_AF_USART1);
